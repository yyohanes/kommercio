...
/******/return __webpack_require__(__webpack_require__.s=33);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){"use strict";var bind=__webpack_require__(7);/*global toString:true*/// utils is a library of generic helper functions non-specific to axios
...
if(utils.isStandardBrowserEnv()){var cookies=__webpack_require__(22);// Add xsrf header
...
request.send(requestData);});};/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(8));/***/},/* 4 *//***/function(module,exports,__webpack_require__){"use strict";/**
...
process.versions={};function noop(){}process.on=noop;process.addListener=noop;process.once=noop;process.off=noop;process.removeListener=noop;process.removeAllListeners=noop;process.emit=noop;process.prependListener=noop;process.prependOnceListener=noop;process.listeners=function(name){return[];};process.binding=function(name){throw new Error('process.binding is not supported');};process.cwd=function(){return'/';};process.chdir=function(dir){throw new Error('process.chdir is not supported');};process.umask=function(){return 0;};/***/},/* 9 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* WEBPACK VAR INJECTION */(function($){/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__kommercio_frontend__=__webpack_require__(29);window._=__webpack_require__(30);window.$=window.jQuery=__webpack_require__(1);window.axios=__webpack_require__(10);window.axios.defaults.headers.common={'X-CSRF-TOKEN':global_vars.csrf_token,'X-Requested-With':'XMLHttpRequest'};__webpack_require__(28);// Add KommercioFrontend to global so legacy JS can use it
window.KommercioFrontend=__WEBPACK_IMPORTED_MODULE_0__kommercio_frontend__["a"/* default */];$(document).ready(function(){__WEBPACK_IMPORTED_MODULE_0__kommercio_frontend__["a"/* default */].init();});/* WEBPACK VAR INJECTION */}).call(__webpack_exports__,__webpack_require__(1));/***/},/* 10 *//***/function(module,exports,__webpack_require__){module.exports=__webpack_require__(11);/***/},/* 11 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);var bind=__webpack_require__(7);var Axios=__webpack_require__(13);var defaults=__webpack_require__(2);/**
...
axios.Cancel=__webpack_require__(4);axios.CancelToken=__webpack_require__(12);axios.isCancel=__webpack_require__(5);// Expose all/spread
axios.all=function all(promises){return Promise.all(promises);};axios.spread=__webpack_require__(27);module.exports=axios;// Allow use of default import syntax in TypeScript
module.exports.default=axios;/***/},/* 12 *//***/function(module,exports,__webpack_require__){"use strict";var Cancel=__webpack_require__(4);/**
 ...
 */CancelToken.source=function source(){var cancel;var token=new CancelToken(function executor(c){cancel=c;});return{token:token,cancel:cancel};};module.exports=CancelToken;/***/},/* 13 *//***/function(module,exports,__webpack_require__){"use strict";var defaults=__webpack_require__(2);var utils=__webpack_require__(0);var InterceptorManager=__webpack_require__(14);var dispatchRequest=__webpack_require__(15);var isAbsoluteURL=__webpack_require__(23);var combineURLs=__webpack_require__(21);/**
...
utils.forEach(['delete','get','head'],function forEachMethodNoData(method){/*eslint func-names:0*/Axios.prototype[method]=function(url,config){return this.request(utils.merge(config||{},{method:method,url:url}));};});utils.forEach(['post','put','patch'],function forEachMethodWithData(method){/*eslint func-names:0*/Axios.prototype[method]=function(url,data,config){return this.request(utils.merge(config||{},{method:method,url:url,data:data}));};});module.exports=Axios;/***/},/* 14 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);function InterceptorManager(){this.handlers=[];}/**
 ...
 */InterceptorManager.prototype.forEach=function forEach(fn){utils.forEach(this.handlers,function forEachHandler(h){if(h!==null){fn(h);}});};module.exports=InterceptorManager;/***/},/* 15 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);var transformData=__webpack_require__(18);var isCancel=__webpack_require__(5);var defaults=__webpack_require__(2);/**
 * Throws a `Cancel` if cancellation has been requested.
...
if(reason&&reason.response){reason.response.data=transformData(reason.response.data,reason.response.headers,config.transformResponse);}}return Promise.reject(reason);});};/***/},/* 16 *//***/function(module,exports,__webpack_require__){"use strict";/**
 ...
 */module.exports=function enhanceError(error,config,code,response){error.config=config;if(code){error.code=code;}error.response=response;return error;};/***/},/* 17 *//***/function(module,exports,__webpack_require__){"use strict";var createError=__webpack_require__(6);/**
...
if(!response.status||!validateStatus||validateStatus(response.status)){resolve(response);}else{reject(createError('Request failed with status code '+response.status,response.config,null,response));}};/***/},/* 18 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);/**
 ...
 */module.exports=function transformData(data,headers,fns){/*eslint no-param-reassign:0*/utils.forEach(fns,function transform(fn){data=fn(data,headers);});return data;};/***/},/* 19 *//***/function(module,exports,__webpack_require__){"use strict";// btoa polyfill for IE<10 courtesy https://github.com/davidchambers/Base64.js
 ...
 */module.exports=function buildURL(url,params,paramsSerializer){/*eslint no-param-reassign:0*/if(!params){return url;}var serializedParams;if(paramsSerializer){serializedParams=paramsSerializer(params);}else if(utils.isURLSearchParams(params)){serializedParams=params.toString();}else{var parts=[];utils.forEach(params,function serialize(val,key){if(val===null||typeof val==='undefined'){return;}if(utils.isArray(val)){key=key+'[]';}if(!utils.isArray(val)){val=[val];}utils.forEach(val,function parseValue(v){if(utils.isDate(v)){v=v.toISOString();}else if(utils.isObject(v)){v=JSON.stringify(v);}parts.push(encode(key)+'='+encode(v));});});serializedParams=parts.join('&');}if(serializedParams){url+=(url.indexOf('?')===-1?'?':'&')+serializedParams;}return url;};/***/},/* 21 *//***/function(module,exports,__webpack_require__){"use strict";/**
 * Creates a new URL by combining the specified URLs
 *
 * @param {string} baseURL The base URL
 * @param {string} relativeURL The relative URL
 * @returns {string} The combined URL
 */module.exports=function combineURLs(baseURL,relativeURL){return baseURL.replace(/\/+$/,'')+'/'+relativeURL.replace(/^\/+/,'');};/***/},/* 22 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);module.exports=utils.isStandardBrowserEnv()?// Standard browser envs support document.cookie
...
function nonStandardBrowserEnv(){return{write:function write(){},read:function read(){return null;},remove:function remove(){}};}();/***/},/* 23 *//***/function(module,exports,__webpack_require__){"use strict";/**
...
return /^([a-z][a-z\d\+\-\.]*:)?\/\//i.test(url);};/***/},/* 24 *//***/function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);module.exports=utils.isStandardBrowserEnv()?// Standard browser envs have full support of the APIs needed to test
 ...
 */module.exports=function parseHeaders(headers){var parsed={};var key;var val;var i;if(!headers){return parsed;}utils.forEach(headers.split('\n'),function parser(line){i=line.indexOf(':');key=utils.trim(line.substr(0,i)).toLowerCase();val=utils.trim(line.substr(i+1));if(key){parsed[key]=parsed[key]?parsed[key]+', '+val:val;}});return parsed;};/***/},/* 27 *//***/function(module,exports,__webpack_require__){"use strict";/**
 ...
 * @returns {Function}
 */module.exports=function spread(callback){return function wrap(arr){return callback.apply(null,arr);};};/***/},/* 28 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function($){window.handleAddressSelector=function(context){$('.address-groups',context).each(function(idx,obj){var $countrySelect=$('.country-select',obj);var $stateSelect=$('.state-select',obj);var $citySelect=$('.city-select',obj);var $districtSelect=$('.district-select',obj);var $areaSelect=$('.area-select',obj);$countrySelect.on('change',function(e){$.ajax(global_vars.base_path+'/address/state/options?first_option=1',{'data':'parent='+$(e.target).val(),'dataType':'json','success':function success(data){var $options=KommercioFrontend.selectHelper.convertToOptions(data);$stateSelect.html($options);$stateSelect.trigger('change');if(data.length<2){$(obj).find('.state-select-wrapper').hide();}else{$(obj).find('.state-select-wrapper').show();}}});});$stateSelect.on('change',function(e){$.ajax(global_vars.base_path+'/address/city/options?first_option=1',{'data':'parent='+$(e.target).val(),'dataType':'json','success':function success(data){var $options=KommercioFrontend.selectHelper.convertToOptions(data);$citySelect.html($options);$citySelect.trigger('change');if(data.length<2){$(obj).find('.city-select-wrapper').hide();}else{$(obj).find('.city-select-wrapper').show();}}});});$citySelect.on('change',function(e){$.ajax(global_vars.base_path+'/address/district/options?first_option=1',{'data':'parent='+$(e.target).val(),'dataType':'json','success':function success(data){var $options=KommercioFrontend.selectHelper.convertToOptions(data);$districtSelect.html($options);$districtSelect.trigger('change');if(data.length<2){$(obj).find('.district-select-wrapper').hide();}else{$(obj).find('.district-select-wrapper').show();}}});});$districtSelect.on('change',function(e){$.ajax(global_vars.base_path+'/address/area/options?first_option=1',{'data':'parent='+$(e.target).val(),'dataType':'json','success':function success(data){var $options=KommercioFrontend.selectHelper.convertToOptions(data);$areaSelect.html($options);$areaSelect.trigger('change');if(data.length<2){$(obj).find('.area-select-wrapper').hide();}else{$(obj).find('.area-select-wrapper').show();}}});});if($countrySelect.find('option').length==2&&$countrySelect.val().length<1){$countrySelect.find('option').prop('selected',false);$countrySelect.find('option:eq(1)').prop('selected',true);$countrySelect.trigger('change');}if($stateSelect.find('option').length<2){$countrySelect.trigger('change');}if($citySelect.find('option').length<2){$stateSelect.trigger('change');}if($districtSelect.find('option').length<2){$citySelect.trigger('change');}if($areaSelect.find('option').length<2){$districtSelect.trigger('change');}});};window.removeEmptyP=function(context){//Remove empty <p> from tab content
$('p:empty',context).remove();};/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(1));/***/},/* 29 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* WEBPACK VAR INJECTION */(function($){var KommercioFrontend=function(){var loadedScripts=[];function isFunction(x){return Object.prototype.toString.call(x)=='[object Function]';}return{init:function init(){this.csrfHeaderSetup(global_vars.csrf_token);this.confirmBtns(document);this.popupBtns(document);$(document).ajaxComplete(function(event,request,settings){if(typeof request.responseJSON!=='undefined'&&typeof request.responseJSON._token!=='undefined'){KommercioFrontend.csrfHeaderSetup(request.responseJSON._token);$('input[name="_token"]').val(request.responseJSON._token);}});},confirmBtns:function confirmBtns(context){$('[data-confirm]',context).each(function(idx,obj){var $message=$(obj).data('confirm');$(obj).on('click',function(){return confirm($message);});});},popupBtns:function popupBtns(context){$('.popup-btn',context).on('click',function(e){e.preventDefault();var width=$(this).data('popup_width')?$(this).data('popup_width'):720;var height=$(this).data('popup_height')?$(this).data('popup_width'):560;window.open($(this).attr('href'),'popup-window','width='+width+',height='+height);});},csrfHeaderSetup:function csrfHeaderSetup(token){$.ajaxPrefilter(function(options,originalOptions,xhr){// this will run before each request
if(token){return xhr.setRequestHeader('X-CSRF-TOKEN',global_vars.csrf_token);// adds directly to the XmlHttpRequest Object
}});},selectHelper:{convertToOptions:function convertToOptions(data,$first_option){var $return='';if(typeof $first_option!=='undefined'){$return+='<option value="">'+$first_option+'</option>';}for(var val in data){$return+='<option value="'+val+'">'+data[val]+'</option>';}return $return;}},convertDotToSquareBracket:function convertDotToSquareBracket(name,forSelector){var parts=String(name).split('.');var returnText='';for(var i in parts){if(i!=0){returnText+=(forSelector?'\\[':'[')+parts[i]+(forSelector?'\\]':']');}else{returnText+=parts[i];}}return returnText;},addError:function addError($name,$message,context){if(typeof context==='undefined'){context=document;}$('[name="'+KommercioFrontend.convertDotToSquareBracket($name,true)+'"]',context).parent().addClass('has-error').append('<div class="help-block">'+$message+'</div>');},clearErrors:function clearErrors(context){$('.has-error',context).removeClass('has-error');$('.help-block',context).remove();$('.alert-danger',context).remove();},toggleOverlay:function toggleOverlay($to,$toggleTo){if($toggleTo){if($to.find('.loading-overlay').length==0){$to.append('<div class="loading-overlay" />');}}else{$to.find('.loading-overlay').remove();}},loadJSScript:function loadJSScript(path,onLoad){if(loadedScripts.indexOf(path)<0){$.getScript(path).done(function(){loadedScripts.push(path);if($.isFunction(onLoad)){onLoad();}}).fail(function(){/* boo, fall back to something else */});}else{if($.isFunction(onLoad)){onLoad();}}},runtimeObjects:{}};}();/* harmony default export */__webpack_exports__["a"]=KommercioFrontend;/* WEBPACK VAR INJECTION */}).call(__webpack_exports__,__webpack_require__(1));/***/},/* 30 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global,module){var __WEBPACK_AMD_DEFINE_RESULT__;/**
 * @license
...
root._=_;}}).call(this);/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(31),__webpack_require__(32)(module));/***/},/* 31 *//***/function(module,exports){var g;// This works in non-strict mode
...
module.exports=g;/***/},/* 32 *//***/function(module,exports){module.exports=function(module){if(!module.webpackPolyfill){module.deprecate=function(){};module.paths=[];// module.parent = undefined by default
if(!module.children)module.children=[];Object.defineProperty(module,"loaded",{enumerable:true,get:function get(){return module.l;}});Object.defineProperty(module,"id",{enumerable:true,get:function get(){return module.i;}});module.webpackPolyfill=1;}return module;};/***/},/* 33 *//***/function(module,exports,__webpack_require__){module.exports=__webpack_require__(9);/***/}]);
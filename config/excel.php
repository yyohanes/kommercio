...
return array(
    ...
    'properties' => [
        'creator'        => env('APP_NAME', 'Fundraising'),
        'lastModifiedBy' => env('APP_NAME', 'Fundraising'),
        'title'          => env('APP_NAME', 'Fundraising'),
        'description'    => env('APP_NAME', 'Fundraising spreadsheet'),
        'subject'        => env('APP_NAME', 'Fundraising spreadsheet'),
        'keywords'       => env('APP_NAME', 'fundraising'),
        'category'       => 'Excel',
        'manager'        => env('APP_NAME', 'Fundraising'),
        'company'        => env('APP_NAME', 'Fundraising'),
    ],

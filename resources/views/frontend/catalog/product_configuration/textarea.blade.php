...
<div class="configuration-field-wrapper">
    ...
    <div class="configuration-field">
        {!! Form::textarea('product_configuration['.$product->id.']['.$productConfiguration->id.']', null, ['maxlength' => ($productConfiguration->getData('rules.max', 0) > 0)?$productConfiguration->getData('rules.max'):null, 'placeholder' => $placeholder, 'class' => 'form-control', 'id' => 'product-'.$product->id.'-'.$productConfiguration->id]) !!}
    </div>
</div>
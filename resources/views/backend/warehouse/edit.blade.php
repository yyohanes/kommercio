...
@section('breadcrumb')
    <li>
        <a href="{{ route('backend.warehouse.index') }}"><span>Warehouse</span></a>
...
@section('content')
    <div class="col-md-12">
        {!! Form::model($warehouse, ['route' => ['backend.warehouse.update', 'id' => $warehouse->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $warehouse->name }} </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.warehouse.create_form')
                </div>

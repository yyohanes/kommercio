...
{!! Form::open(['class' => 'form-client-validation', 'route' => ['backend.sales.order.delivery_order.resend_email', 'process' => $process, 'id' => $deliveryOrder->id]]) !!}
    ...
    <div class="form-body">
        @include('backend.master.form.fields.email', [
            ...
            'attr' => [
                ...
                'placeholder' => $deliveryOrder->order->billingInformation->email,
            ],
            'defaultValue' => $deliveryOrder->order->billingInformation->email,
        ])

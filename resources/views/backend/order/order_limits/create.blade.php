...
@section('breadcrumb')
    ...
    <li>
        <span>Create {{ \Kommercio\Models\Order\OrderLimit::getTypeOptions($type) }} Order Limit</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($orderLimit, ['route' => ['backend.order_limit.store', 'type' => $type], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase">Create {{ \Kommercio\Models\Order\OrderLimit::getTypeOptions($type) }} Order Limit</span>
                </div>
                <div class="actions">

...
<div class="modal-header">
    ...
    <h4 class="modal-title">Process {{ $processedCount.' '.str_plural('Order', $processedCount) }}</h4>
</div>
...
<div class="modal-body">
    @if($unprocessedCount > 0)
        <div class="alert alert-danger">
            {{ $unprocessedCount }} {{ str_plural('order', $unprocessedCount) }} can't be set to Processing.
            <ul>
    ...
    @if($processedCount > 0)
        <p>You are about to set {{ $processedCount }} {{ str_plural('order', $processedCount) }} to <em>Processing</em>.</p>
    @endif
</div>
...
<div class="modal-footer text-center">
    ...
    <div class="pull-right">
        ...
        {!! Form::hidden('action', 'process:processing') !!}

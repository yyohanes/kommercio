...
@section('breadcrumb')
    ...
    <li>
        <span>Edit {{ $priceRule->name }} - Cart Price Rule</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($priceRule, ['route' => ['backend.price_rule.cart.update', 'id' => $priceRule->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $priceRule->name }} - Cart Price Rule </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.price_rule.cart.create_form')
                </div>

...
@section('breadcrumb')
    ...
    <li>
        <span>Create Product Price Rule</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($priceRule, ['route' => ['backend.price_rule.product.store'], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Create Product Price Rule </span>
                </div>
                <div class="actions">

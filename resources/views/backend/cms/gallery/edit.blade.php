...
@section('content')
    <div class="col-md-12">
        {!! Form::model($gallery, ['route' => ['backend.cms.gallery.update', 'id' => $gallery->id], 'files' => TRUE, 'class' => 'form-horizontal files-upload-form']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $gallery->name }} </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.cms.gallery.create_form')
                </div>

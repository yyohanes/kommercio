...
@section('breadcrumb')
    ...
    <li>
        <a href="{{ route('backend.cms.page.index') }}"><span>Page</span></a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
...
@section('content')
    <div class="col-md-12">
        {!! Form::model($page, ['route' => ['backend.cms.page.update', 'id' => $page->id], 'files' => TRUE, 'class' => 'form-horizontal files-upload-form']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $page->name }} </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.cms.page.create_form')
                </div>

...
@section('breadcrumb')
    ...
    <li>
        <span>Edit {{ $bannerGroup->name }}</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($bannerGroup, ['route' => ['backend.cms.banner_group.update', 'id' => $bannerGroup->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $bannerGroup->name }} </span>
                </div>
                <div class="actions">

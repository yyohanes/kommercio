...
@section('content')
    <div class="col-md-12">
        {!! Form::model($menu, ['route' => ['backend.cms.menu.update', 'id' => $menu->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $menu->name }} </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.cms.menu.create_form')
                </div>

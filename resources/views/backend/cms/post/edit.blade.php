...
@section('breadcrumb')
    ...
    <li>
        <a href="{{ route('backend.cms.post.index') }}"><span>Page</span></a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        <span>Edit {{ $post->name }}</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($post, ['route' => ['backend.cms.post.update', 'id' => $post->id], 'files' => TRUE, 'class' => 'form-horizontal files-upload-form']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $post->name }} </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.cms.post.create_form')
                </div>

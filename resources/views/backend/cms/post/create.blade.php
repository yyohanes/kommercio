...
@section('content')
    <div class="col-md-12">
        {!! Form::model($post, ['route' => ['backend.cms.post.store'], 'files' => TRUE, 'class' => 'files-upload-form form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Create Post </span>
                </div>
                <div class="actions">

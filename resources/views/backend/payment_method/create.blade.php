...
@section('content')
    <div class="col-md-12">
        {!! Form::model($paymentMethod, ['route' => ['backend.payment_method.store'], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Create Payment Method </span>
                </div>
                <div class="actions">

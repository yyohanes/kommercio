...
@section('breadcrumb')
    ...
    <li>
        <span>Edit Customer - {{ $customer->fullName }}</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($customer, ['route' => ['backend.customer.update', 'id' => $customer->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase">Edit Customer - {{ $customer->fullName }}</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.customer.create_form')
                </div>

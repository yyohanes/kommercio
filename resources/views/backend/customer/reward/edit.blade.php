...
@section('breadcrumb')
    ...
    <li>
        <span>Edit Reward - {{ $reward->name }}</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($reward, ['route' => ['backend.customer.reward.update', 'id' => $reward->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit Reward - {{ $reward->name }} </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.customer.reward.create_form')
                </div>

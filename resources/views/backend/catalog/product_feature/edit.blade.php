...
@section('breadcrumb')
    ...
    <li>
        <span>Edit {{ $productFeature->name }}</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($productFeature, ['route' => ['backend.catalog.product_feature.update', 'id' => $productFeature->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $productFeature->name }} </span>
                </div>
                <div class="actions">

...
@section('content')
    <div class="col-md-12">
        {!! Form::model($category, ['route' => ['backend.catalog.category.store'], 'files' => TRUE, 'class' => 'files-upload-form form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Create Category </span>
                </div>
                <div class="actions">

...
@section('breadcrumb')
    ...
    <li>
        <a href="{{ route('backend.catalog.category.index') }}"><span>Category</span></a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
...
@section('content')
    <div class="col-md-12">
        {!! Form::model($category, ['route' => ['backend.catalog.category.update', 'id' => $category->id], 'files' => TRUE, 'class' => 'form-horizontal files-upload-form']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $category->name }} </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.catalog.category.create_form')
                </div>

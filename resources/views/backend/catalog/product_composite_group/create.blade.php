...
@section('content')
    <div class="col-md-12">
        {!! Form::model($productCompositeGroup, ['route' => ['backend.catalog.product_composite.group.store'], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Create Composite </span>
                </div>
                <div class="actions">

                        ...
                        @foreach($product->productFeatures as $feature)
                            <div class="row form-group">
                                ...
                                <div class="col-sm-3 col-xs-4">
                                    {!! Form::select('variation[features]['.$feature->id.']', ['' => '-'] + $feature->getValueOptions(), old('variation.features.'.$feature->id, $variation?$variation->getProductFeatureValue($feature->id):$product->getProductFeatureValue($feature->id)), ['class' => 'form-control']) !!}
                                </div>
                                <div class="col-sm-3 col-xs-4">

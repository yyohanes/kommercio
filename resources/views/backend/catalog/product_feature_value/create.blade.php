...
@section('breadcrumb')
    ...
    <li>
        <span>Create {{ $productFeature->name }} Value</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($productFeatureValue, ['route' => ['backend.catalog.product_feature.value.store', 'feature_id' => $productFeature->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Create {{ $productFeature->name }} Value </span>
                </div>
                <div class="actions">

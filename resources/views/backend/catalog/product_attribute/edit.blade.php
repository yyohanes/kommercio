...
@section('breadcrumb')
    ...
    <li>
        <span>Edit {{ $productAttribute->name }}</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($productAttribute, ['route' => ['backend.catalog.product_attribute.update', 'id' => $productAttribute->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $productAttribute->name }} </span>
                </div>
                <div class="actions">

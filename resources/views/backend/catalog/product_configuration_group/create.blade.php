...
@section('content')
    <div class="col-md-12">
        {!! Form::model($productConfigurationGroup, ['route' => ['backend.catalog.product_configuration.group.store'], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Create Configuration </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.catalog.product_configuration_group.create_form')
                </div>

...
@section('breadcrumb')
    ...
    <li>
        <span>Edit {{ $shippingMethod->name }}</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($shippingMethod, ['route' => ['backend.shipping_method.update', 'id' => $shippingMethod->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $shippingMethod->name }} </span>
                </div>
                <div class="actions">

...
@section('breadcrumb')
    <li>
        <a href="{{ route('backend.store.index') }}"><span>Store</span></a>
...
@section('content')
    <div class="col-md-12">
        {!! Form::model($store, ['route' => ['backend.store.update', 'id' => $store->id], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Edit {{ $store->name }} </span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="form-body">
                    @include('backend.store.create_form')
                </div>

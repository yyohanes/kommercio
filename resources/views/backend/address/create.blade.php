...
@section('breadcrumb')
    ...
    <li>
        <span>Create {{ ucfirst($address->addressType) }}</span>
    </li>
@stop

@section('content')
    <div class="col-md-12">
        {!! Form::model($address, ['route' => ['backend.configuration.address.store', 'type' => $type, 'parent_id' => $parentObj?$parentObj->id:null], 'class' => 'form-horizontal']) !!}
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject sbold uppercase"> Create {{ ucfirst($address->addressType) }} </span>
                </div>
                <div class="actions">
